...
const FILE_CONTENTS: Record<string, Record<'es' | 'en', string[]>> = {
    ...
    'about.md': {
        es: [
            '# Quién Soy',
            '',
            'Desarrollador junior enfocado actualmente en TypeScript y su ecosistema.',
            'Construyendo cosas útiles mientras aprendo en el proceso.',
            '',
            '- Ubicación: Honduras 🇭🇳',
        ...
        en: [
            '# About Me',
            '',
            'Junior developer currently focused on TypeScript and its ecosystem.',
            'Building useful things while learning along the way.',
            '',
            '- Location: Honduras 🇭🇳',
